...
ActiveRecord::Schema.define(version: 20140919112649) do
  ...
  add_index "posts", ["content_id", "content_type"], name: "index_posts_on_content_id_and_content_type", using: :btree
